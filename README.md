...
| **Putting an agent on a human team, or wondering what the research actually says** | [Building an AI-Agent Workforce](guides/building-ai-agent-workforce.md) — research-grounded: MAST failure taxonomy, trust calibration from *Human Factors*, evaluation benchmarks that predict production behavior, and eight operational lessons from running an agent as a production teammate |
...
| **Curious about the intellectual history behind AI agent memory — where obligation tracking, commitment graphs, and speech act extraction come from** | [The Intellectual Lineage of the Commitment Graph](guides/commitment-graph-intellectual-lineage.md) — traces the obligation edge from Austin (1962) through Singh (1999) to Cupid (2015); explains why Winograd & Flores were right in 1986 but thirty-five years early |
...
- [The Intellectual Lineage of the Commitment Graph](guides/commitment-graph-intellectual-lineage.md) — where the directed obligation edge comes from: Austin (1962) → Searle (1975) → Winograd & Flores (1986) → Singh (1999) → Cupid (2015), plus the REA accounting ontology and the Fellegi-Sunter dedup gate. Why The Coordinator failed and what LLM extraction finally unlocks. Seven primary sources ranked by what to read first.
...
- [building-ai-agent-workforce](skills/building-ai-agent-workforce/) — six-dimension audit (organizational design, containment, escalation, trust calibration, measurement, production-readiness checklist) for any agent or agent system
