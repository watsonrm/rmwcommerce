...
- [Configuring `.claude/settings.local.json`: What Actually Matters](configuring-claude-code-permissions.md) — what the built-in read-only allowlist already covers, what patterns are cargo cult, and a verified starter recipe drawn from 213 lines of real-world use.
